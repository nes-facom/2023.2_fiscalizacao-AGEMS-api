...
public interface QuestaoFormularioRepositorio extends CrudRepository<QuestaoFormulario, Integer> {
  @Operation(summary = "Encontra questões-formulário por formulario")
 public List<QuestaoFormulario> findByFormulario(Formulario formulario);
  
  @Operation(summary = "Encontra questões-formulário por questão")
 public List<QuestaoFormulario> findByQuestao(Questao questao);
}
